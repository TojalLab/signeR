...
There are two main downstream analysis:
  ...
  - **Covariate**
    - *Categorical feature*: differences in exposures among groups can be analysed and if some of the samples are unlabeled they can be labeled based on the similarity of their exposure profiles to those of labeled samples.
    - *Continuous feature*: its correlation to estimated exposures can be evaluated.
    - *Survival feature*: survival data can also be analysed and the relation of signatures to survival can be accessed. 
...
![](figure/flow_clustering_dist.png)

![](figure/flow_clustering_method.png)
...
![](figure/flow_clinical_summary.png)
...
![](figure/flow_tcga_filter_covariate.png) 
